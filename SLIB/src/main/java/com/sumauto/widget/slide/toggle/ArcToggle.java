...
import com.sumauto.widget.slide.toggle.shape.ArcShape;
import com.sumauto.widget.slide.toggle.shape.ArcTransformer;
...
public class ArcToggle extends ToggleView {
    ...
    public ArcToggle(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        transformer = new ArcTransformer(new ArcShape(0, 0, new RectF(), true),
